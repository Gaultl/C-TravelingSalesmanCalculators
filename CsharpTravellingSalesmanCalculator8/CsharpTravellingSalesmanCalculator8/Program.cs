...
namespace Not_quantum_traveling_salesman_calculator
{
    class Program
    {
        static void Main()
        {
            ...
            double[] xvals = { 10, 13, 12, 4, -17, 14, 14, -7 };
            double[] yvals = { -5, 19, 5, 15, 9, 12, 0, 3 };
            ...
            while (a < points)
            {
                ...
                if (a == b || a == c || a == d || a == e || a == f || a == g || b == c || b == d || b == e || b == f || b == g || c == d || c == e || c == f || c == g || d == e || d == f || d == g || e == f || e == g || f == g || a == points)
                {
                    g++;
                }
                else
            ...
            Console.WriteLine("{0} {1} {2} {3} {4} {5} {6} {7} {8} ", complps[rownum, 0], complps[rownum, 1], complps[rownum, 2], complps[rownum, 3], complps[rownum, 4], complps[rownum, 5], complps[rownum, 6], complps[rownum, 7], complps[rownum, 8]);
